...
/// Why a dialing central or peripheral opened this BLE connection.
///
/// The preamble is the first frame sent in the clear, so every failure
/// here is pre-authentication invalid input: the connection closes and no
/// stored state changes.
internal enum BleRendezvous: Equatable {
  case pairing
  ...
  private static let domain = "RAPP-ble-v1"
